...
function VirtualClassRoom(props) {
	...
	function init_video(role) {
		...
		connection = new signalR.HubConnectionBuilder()
			.withUrl(`http://127.0.0.1:51044/p/Courses/3fa85f64-5717-4562-b3fc-2c963f66afa6/Classrooms/${classID}/join`)
			.build();
					...
					<div className="content">
						<Row>
							<Col sm="9">
								...
								{role == 'Instructor' && <Button onClick={createScreen}>Create Screen</Button>}
